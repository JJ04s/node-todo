import type { DETAILED_ERROR } from '../domain/detailed-error.js';
import type { InputRepository } from '../domain/input-interface.js';
import type { OutputPresenter } from '../domain/output-interface.js';
